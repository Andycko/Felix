          ...
          <ScrollView contentContainerStyle={styles.scrollText} showsVerticalScrollIndicator={false} style={[styles.wrapSub]}>
            ...
            <View>
              <Text style={[styles.textSub]}>
                ...
                802.11 is the name for the working group from the Institute of Electrical and Electronic Engineers (IEEE) 
                ...
                The IEEE identifies each standard with a letter. For example, 802.11a is different from 802.11b. 
                ...
                For the most part, the differences between standards are in speed, modulation techniques, 
                ...
                it might not work for 802.11a or even 802.11g. Because the underlying protocols 
